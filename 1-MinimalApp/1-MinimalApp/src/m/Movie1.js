 ...
 * @constructor
 * @param {{movieId: number, title: string, year: number}} slots - Object creation slots.
 */
...
Movie.generateTestData = function () {
  Movie.instances["1"] = new Movie({movieId:"1", title:"Pulp Fiction", year:"1994-05-12"});
  Movie.instances["2"] = new Movie({movieId:"2", title:"Star Wars", year:"1977-05-25"});
  Movie.instances["3"] = new Movie({movieId:"3", title:"Casablanca", year:"1943-01-23"});
  Movie.instances["4"] = new Movie({movieId:"4", title:"The Godfather", year:"1972-03-15"});
  Movie.saveAll();
};
//  Clear data
